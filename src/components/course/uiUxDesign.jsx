...
import image1 from '../../assets/course/Image4.png'
...
function uiUxDesign() {
  ...
  return (
    ...
    <div className=' h-64 items-center-safe ml-36 pl-2 justify-center grid grid-cols-2  w-[80%]'>
      <h1 className='text-5xl ml-20 font-bold'>UI/UX Design Course</h1>
      <p>Welcome to our UI/UX Design course! This comprehensive program will equip you with the knowledge and 
        skills to create exceptional user interfaces (UI) and enhance user experiences (UX). Dive into 
        the world of design thinking, wireframing, prototyping, and usability testing. 
        Below is an overview of the curriculum</p>
    </div>
    ...
    <div class="grid grid-cols-2 items-center-safe ml-36 justify-between w-[80%] min-h-screen p-4">
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Introduction to UI/UX Design</h3>
          </div>
        ...
        <div class="space-y-3">
          ...
          <div class="bg-gray-50 border border-gray-200 hover:border-orange-400 hover:bg-orange-50 rounded-lg px-4 py-3">
            <p class="text-sm font-medium text-gray-700 mb-1">Understanding UI/UX Design Principles</p>
          ...
          {/* <!-- Lesson 3 --> */}
          <div class="bg-gray-50 border border-gray-200 hover:border-orange-400 hover:bg-orange-50 rounded-lg px-4 py-3">
            <p class="text-sm font-medium text-gray-700 mb-1">The Role of UI/UX Design in Product Development</p>
            <div class="flex justify-between text-xs text-gray-500">
              <span>Lesson 03</span>
              <span class="flex items-center gap-1">
                🕒 <span>45 Minutes</span>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">User Research and Analysis</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Wireframing and Prototyping</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Visual Design and Branding</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Usability Testing and Iteration</h3>
          </div>
