...
import image1 from '../../assets/course/Image14.png'
...
function graphicDesign() {
  ...
  return (
    ...
    <div className=' h-64 items-center-safe ml-36 pl-2 justify-center grid grid-cols-2  w-[80%]'>
      <h1 className='text-5xl ml-20 font-bold'>Graphic Design for Beginners</h1>
      <p>Welcome to our Graphic Design for Beginner course! Discover the fundamentals of graphic design, including 
        typography, color theory, layout design, and image manipulation techniques. Create visually 
        stunning designs for print and digital media.</p>
    </div>
    ...
    <div class="grid grid-cols-2 items-center-safe ml-36 justify-between w-[80%] min-h-screen p-4">
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Introduction to Graphic Design</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Typography and Color Theory</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Layout Design and Composition</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Image Editing and Manipulation</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Designing for Print and Digital Media</h3>
          </div>
