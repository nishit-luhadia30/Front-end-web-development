...
import image1 from '../../assets/course/Image7.png'
...
function mobileAppDevelopment() {
  ...
  return (
    ...
    <div className=' h-64 items-center-safe ml-36 pl-2 justify-center grid grid-cols-2  w-[80%]'>
      <h1 className='text-5xl ml-20 font-bold'>Mobile App Development</h1>
      <p>Welcome to our Mobile App Development course! Dive into the world of mobile app development. Learn to build native iOS
          and Android applications using industry-leading frameworks like Swift and Kotlin.</p>
    </div>
    ...
    <div class="grid grid-cols-2 items-center-safe ml-36 justify-between w-[80%] min-h-screen p-4">
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Introduction to Mobile App Development</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Fundamentals of Swift Programming (iOS)</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Fundamentals of Kotlin Programming (Android)</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">Building User Interfaces</h3>
          </div>
      ...
      <div class="bg-white rounded-xl shadow border p-6 w-full max-w-md ml-10 mb-10 mt-10">
        ...
        <div class="flex justify-between items-start mb-4">
          <div>
            <h3 class="text-lg font-semibold mb-1">App Deployment and Testing</h3>
          </div>
