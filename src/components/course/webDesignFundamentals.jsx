...
import image1 from '../../assets/course/Image3.png'
import Light from '../../assets/home/light.png'

function webDesignFundamentals() {
  ...
  return (
    ...
    <div className=' h-64 items-center-safe ml-36 pl-2 justify-center grid grid-cols-2  w-[80%]'>
      <h1 className='text-5xl ml-20 font-bold'>Web Design Fundamentals</h1>
      <p>Welcome to our Web Design FUndamentals course! Web design basics? It's all about making sites that look good 
        and feel smooth. Think clean layouts, aesthetic vibes, and buttons that actually make sense. Gotta 
        be mobile-friendly too—'cause if it flops on the phone, it flops hard.</p>
    </div>
